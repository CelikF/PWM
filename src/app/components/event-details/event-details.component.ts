...
import { FavoritesService } from 'src/app/services/favorite-storage/favorite-storage.service';
...
export class EventDetailsComponent {
  ...
  async toggleFavorite() {
    ...
    if (this.isFavorite) {
      ...
      toast.info("Event has been removed from your favorites.")
    } else {
      await this.favoritesService.addFavorite(uid, this.eventId);
      toast.info("Event has been added to your favorites.")
    }
