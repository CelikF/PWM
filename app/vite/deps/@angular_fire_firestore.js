...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  k(e) {
    return __async(this, null, function* () {
      return this.db || (__PRIVATE_logDebug($, "Opening database:", this.name), this.db = yield new Promise((t, n) => {
...
var __PRIVATE_LruScheduler = class {
  ...
  Ir(e) {
    __PRIVATE_logDebug(Ft, `Garbage collection scheduled in ${e}ms`), this.Tr = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, () => __async(this, null, function* () {
      this.Tr = null;
      try {
        yield this.localStore.collectGarbage(this.garbageCollector);
      } catch (e2) {
        __PRIVATE_isIndexedDbTransactionError(e2) ? __PRIVATE_logDebug(Ft, "Ignoring IndexedDB error during garbage collection: ", e2) : yield __PRIVATE_ignoreIfPrimaryLeaseLoss(e2);
      }
      yield this.Ir(3e5);
    }));
  }
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
   ...
   */
  Ki(e) {
    return this.Ni = (t) => __async(this, null, function* () {
  ...
  setDatabaseDeletedListener(e) {
    this.Li.U((t) => __async(this, null, function* () {
  ...
  setNetworkEnabled(e) {
    ...
    this.bi.enqueueAndForget(() => __async(this, null, function* () {
      this.started && (yield this.qi());
    })));
  }
  /**
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.Li.runTransaction("shutdown", "readwrite", [j, ge], (e) => {
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  start() {
    return __async(this, null, function* () {
      const e = yield this.syncEngine.us();
      for (const t2 of e) {
  ...
  Gs(e) {
    ...
    if (t.storageArea === this.storage) {
      ...
      this.bi.enqueueRetryable(() => __async(this, null, function* () {
        if (this.started) {
          if (null !== t.key) {
            if (this.Ys.test(t.key)) {
              ...
              yield Promise.all(e2.map((e3) => this.syncEngine.po(e3)));
            }
          }
        } else this.js.push(t);
      }));
...
var __PRIVATE_PersistentStream = class {
  ...
  S_() {
    this.state = 5, this.y_.E_(() => __async(this, null, function* () {
  ...
  constructor(e, t, n, r, i) {
    ...
    this.ua = [], this.ca = i, this.ca.vo((e2) => {
      n.enqueueAndForget(() => __async(this, null, function* () {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Yt, "Restarting streams for network reachability change."), yield function __PRIVATE_restartNetwork(e3) {
          return __async(this, null, function* () {
            const t2 = __PRIVATE_debugCast(e3);
            t2.aa.add(
              4
              /* OfflineCause.ConnectivityChange */
            ), yield __PRIVATE_disableNetworkInternal(t2), t2.la.set(
              "Unknown"
              /* OnlineState.Unknown */
            ), t2.aa.delete(
              4
...
function __PRIVATE_enableNetworkInternal(e) {
  return __async(this, null, function* () {
    if (__PRIVATE_canUseNetwork(e)) for (const t of e.ua) yield t(
      /* enabled= */
      true
    );
  });
  ...
  return __async(this, null, function* () {
    if (
        ...
        yield function __PRIVATE_handleTargetError(e2, t2) {
          return __async(this, null, function* () {
            ...
            for (const r of t2.targetIds)
              e2._a.has(r) && (yield e2.remoteSyncer.rejectListen(r, n2), e2._a.delete(r), e2.ha.removeTarget(r));
          });
        }(e, t);
      } catch (n2) {
        __PRIVATE_logDebug(Yt, "Failed to remove targets %s: %s ", t.targetIds.join(","), n2), yield __PRIVATE_disableNetworkUntilRecovery(e, n2);
      }
      ...
      */
      ...
      __PRIVATE_logDebug(Yt, "Failed to raise snapshot:", t2), yield __PRIVATE_disableNetworkUntilRecovery(e, t2);
    }
  });
}
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    yield __PRIVATE_disableNetworkInternal(e), e.la.set(
      "Offline"
      /* OnlineState.Offline */
    ...
    e.asyncQueue.enqueueRetryable(() => __async(null, null, function* () {
      __PRIVATE_logDebug(Yt, "Retrying IndexedDB access"), yield n(), e.aa.delete(
        1
        /* OfflineCause.IndexedDbFailed */
    ...
    (yield function __PRIVATE_handleWriteError(e2, t2) {
      return __async(this, null, function* () {
        if (function __PRIVATE_isPermanentWriteError(e3) {
          ...
          const n = e2.oa.shift();
          __PRIVATE_ensureWriteStream(e2).D_(), yield __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    n.la.set(
      "Unknown"
      /* OnlineState.Unknown */
    ), yield n.remoteSyncer.handleCredentialChange(t), n.aa.delete(
      3
      /* OfflineCause.CredentialChange */
...
function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    ), yield __PRIVATE_enableNetworkInternal(n)) : t || (n.aa.add(
      2
      /* OfflineCause.IsSecondary */
    ), yield __PRIVATE_disableNetworkInternal(n), n.la.set(
      "Unknown"
      /* OnlineState.Unknown */
    ));
  });
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  }), e.ua.push((t) => __async(null, null, function* () {
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.Ta = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.Ta.stop(), e.oa.length > 0 && (__PRIVATE_logDebug(Yt, `Stopping write stream with ${e.oa.length} pending writes`), e.oa = []));
  }))), e.Ta;
}
...
var __PRIVATE_BundleLoader = class {
  ...
  complete() {
    return __async(this, null, function* () {
      const e = yield __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.Oa.id), t = this.Ba(this.documents);
...
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    }), yield Promise.all(o), r.nu.Q_(i), yield function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    if (!n.currentUser.isEqual(t)) {
      ...
      n.sharedClientState.handleUserChange(t, e2.removedBatchIds, e2.addedBatchIds), yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2.Ms);
    }
  });
}
...
function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.hu) {
      ...
      n.hu = true, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
      ...
      }(n), n.hu = false, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
    ...
    return __async(this, null, function* () {
      try {
        ...
        for (; s; ) {
          ...
          e3 && n2._updateProgress(e3), s = yield t2.du();
        }
...
var __PRIVATE_MemoryOfflineComponentProvider = class {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      this.serializer = __PRIVATE_newSerializer(e.databaseInfo.databaseId), this.sharedClientState = this.Au(e), this.persistence = this.Ru(e), yield this.persistence.start(), this.localStore = this.Vu(e), this.gcScheduler = this.mu(e, this.localStore), this.indexBackfillerScheduler = this.fu(e, this.localStore);
    });
  }
  mu(e, t) {
    return null;
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends __PRIVATE_MemoryOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(___PRIVATE_IndexedDbOfflineComponentProvider.prototype, this, "initialize").call(this, e), yield this.gu.initialize(this, e), // Enqueue writes from a previous session
      yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.gu.syncEngine), yield __PRIVATE_fillWritePipeline(this.gu.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
      // set it after localStore / remoteStore are started.
      yield this.persistence.Ki(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
    });
  }
  Vu(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
...
var __PRIVATE_MultiTabOfflineComponentProvider = class ___PRIVATE_MultiTabOfflineComponentProvider extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      // set it after localStore / remoteStore are started.
      yield this.persistence.Ki((e2) => __async(this, null, function* () {
        yield __PRIVATE_syncEngineApplyPrimaryState(this.gu.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
      }));
    });
  }
  Au(e) {
    ...
    return __async(this, null, function* () {
      ...
      yield function __PRIVATE_remoteStoreShutdown(e2) {
        return __async(this, null, function* () {
          ...
          ), yield __PRIVATE_disableNetworkInternal(t2), t2.ca.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  du() {
    return __async(this, null, function* () {
      return yield this.getMetadata(), this.Su();
    });
  }
  /**
  ...
  Cu(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.Mu()) && this.vu("Reached the end of bundle when more is expected.");
      }
    ...
    return __async(this, null, function* () {
      ...
      const t = yield function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
          ...
          }, i = yield n.Wo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
          i.forEach((e3) => {
    ...
    return __async(this, null, function* () {
      ...
      e.forEach((e2, t) => {
        ...
        return __async(this, null, function* () {
          ...
          yield n.Qo("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r);
        });
...
var __PRIVATE_TransactionRunner = class {
  ...
  Bu() {
    this.y_.E_(() => __async(this, null, function* () {
...
var FirestoreClient = class {
  constructor(e, t, n, r, i) {
    this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this.databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, (e2) => __async(this, null, function* () {
      __PRIVATE_logDebug(tn, "Received user=", e2.uid), yield this.authCredentialListener(e2), this.user = e2;
...
function __PRIVATE_setOnlineComponentProvider(e, t) {
  return __async(this, null, function* () {
    ...
    __PRIVATE_logDebug(tn, "Initializing OnlineComponentProvider"), yield t.initialize(n, e.configuration), // The CredentialChangeListener of the online component provider takes
...
function __PRIVATE_ensureOfflineComponents(e) {
  return __async(this, null, function* () {
    ...
    } else __PRIVATE_logDebug(tn, "Using default OfflineComponentProvider"), yield __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
    return e._offlineComponents;
  });
}
function __PRIVATE_ensureOnlineComponents(e) {
  return __async(this, null, function* () {
    return e._onlineComponents || (e._uninitializedComponentsProvider ? (__PRIVATE_logDebug(tn, "Using user provided OnlineComponentProvider"), yield __PRIVATE_setOnlineComponentProvider(e, e._uninitializedComponentsProvider._online)) : (__PRIVATE_logDebug(tn, "Using default OnlineComponentProvider"), yield __PRIVATE_setOnlineComponentProvider(e, new OnlineComponentProvider()))), e._onlineComponents;
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
    ...
    n.yu(), e.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  Zu() {
    return __async(this, null, function* () {
      if (0 !== this.Qu.length) {
        try {
          yield this.Qu[0](), this.Qu.shift(), this.y_.reset();
        } catch (e) {
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
    ...
    return e2.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
      ...
      i2.yu(), e2.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
