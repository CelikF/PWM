...
var _FunctionsModule = class _FunctionsModule {
  constructor() {
    registerVersion("angularfire", VERSION.full, "fn");
  }
};
__publicField(_FunctionsModule, "ɵfac", function FunctionsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FunctionsModule)();
});
__publicField(_FunctionsModule, "ɵmod", ɵɵdefineNgModule({
  type: _FunctionsModule
}));
__publicField(_FunctionsModule, "ɵinj", ɵɵdefineInjector({
  providers: [DEFAULT_FUNCTIONS_INSTANCE_PROVIDER, FUNCTIONS_INSTANCES_PROVIDER]
}));
var FunctionsModule = _FunctionsModule;
(() => {
